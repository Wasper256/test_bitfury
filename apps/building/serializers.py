...
from apps.shared.utils import share_custom_validator, calculate_relative_share
from .models import Building, BuildingOwners


class ShareholdersRetrieveSerializer(serializers.ModelSerializer):
    ...
    #     if not obj.share:
    #         return calculate_relative_share(obj, BuildingOwners)
    #     else:
    #         return obj.share
...
class BuildingRetrieveSerializer(serializers.ModelSerializer):
    ...
    def get_shareholders(self, obj):
        return ShareholdersRetrieveSerializer(
