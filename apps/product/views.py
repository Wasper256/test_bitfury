...
from .serializers import (
    ProductRetrieveSerializer, ProductBaseSerializer,
...
class ProductViewSet(viewsets.ModelViewSet):
    """
    ViewSet to handle all Product CRUD actions.
    ...
    def update_share(self, request, *args, **kwargs):
        ...
        # solution to make update and create in single action endpoint
            ...
            if serializer.errors.get('non_field_errors')[0] == (
                ...
                ProductOwners.objects.filter(
                    shared_object=serializer.initial_data.get('object'),
    ...
    def delete_share(self, request, *args, **kwargs):
        ...
        serializer.is_valid(raise_exception=True)
        deleted = ProductOwners.objects.filter(
